...
model1 = genai.GenerativeModel(
    ...
    system_instruction="Voce é um professor de ingles.Inicie perguntando em voce poderia ajudar : Em que eu poderia ajudar? -caso a pessoa diga seu proprio nome , repita o nome dela ao final da frase inicial."
)
...
if audio_value:
    try:
        ...
        # Envia para modulo geekc
        geekc.text_to_speech(resposta)
